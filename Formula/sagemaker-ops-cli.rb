class SagemakerOpsCli < Formula
  include Language::Python::Virtualenv

  desc "CLI and TUI for SageMaker Processing Jobs and Pipelines"
  homepage "https://github.com/southpolemonkey/smops"
  url "https://files.pythonhosted.org/packages/3b/99/6389b758e6442b8f49075d52ea44c7c8deb1a3844a9ae8d0b628e4dcd1c9/sagemaker_ops_cli-0.1.0.tar.gz"
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/smops --version")
  end
end
